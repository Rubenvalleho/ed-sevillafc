package com.rubenvj.sevillafc.features.employee.domain.player.data.local;
...
public class PlayerFileLocalDataSource {
    ...
    private String nameFile = "player.txt";
    ...
    public void savePlayer(Player player) {
        try {
            ...
            myWriter.write(gson.toJson(player) + System.lineSeparator());
            myWriter.close();
